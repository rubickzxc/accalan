...
class bullet(GameSprite):
    def __init__(self,player_image, player_x, player_y,size_x, size_y,speed):
        spite.Sprite.__init__(self,player_image, player_x, player_y,size_x, size_y)
        self.speed = speed
    def update(self):
        self.rect.x += self.speed
...
#создаём спрайты
packman = Player('5f3065e516b8cfbe5e4dc57b40f8073c_o.jpg', 5, win_height - 80, 80, 80, 0, 0)
monster = Enemy('1645481865_65-kartinkin-net-p-kartinki-khorror-71.jpg', win_width - 80, 180, 80, 80, 2)
final_sprite = GameSprite('calendar.png', win_width - 85, win_height - 100, 80, 80)
...
while run:
 ...
 if not finish:
   ...
   if sprite.collide_rect(packman, monster):
       finish = True
       #вычисляем отношение
       img = image.load('пельмени_куриные.jpg')
